...
t <- kable(coefs, format = 'latex', booktabs = TRUE, caption='Coefficients from models (including education).', col.names = c('',c('NAME','SSA','Asia','Latin America', 'Stage1', 'All countries')), digits = 2, escape = FALSE) %>%
